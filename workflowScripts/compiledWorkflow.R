...
pathKeys<-"./Inputs/compiledKeys_2008-2020.csv"
#path to compiled crosswalks file
pathCrosswalks<-"./Inputs/compileCrosswalks_2008-2020.csv"
#path for output of CD results
outputData_path<-"./Results/"
#path for output of plant association results
pathWrite<-"./unPublishedOutputs"
#path to save EIA data pulled from web
pathSaveEIA<-"./unPublishedOutputs/EIA_data/"
