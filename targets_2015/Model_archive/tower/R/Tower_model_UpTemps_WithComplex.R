...
input_header = 'Model_archive/tower/Data/Tower_input_header_data.csv'
input_data = 'Model_archive/tower/Data/Tower_input_UpTemps_WithComplex.csv'
CTI_input = 'Model_archive/tower/Data/CTI_input.csv'
...
## read from CSV file
data = read.csv(input_data, header=T,na.strings="-", stringsAsFactors = FALSE)
...
location = read.csv('Model_archive/tower/Data/plant_locations.csv', header=T)
...
write.csv(evap_out, 'Model_archive/tower/Output/Tower_model_evap_out_UpTemps_WithComplex.csv',row.names=F)
...
write.csv(consumption_out,'Model_archive/tower/Output/Tower_model_consumption_out_UpTemps_WithComplex.csv', row.names=F)
