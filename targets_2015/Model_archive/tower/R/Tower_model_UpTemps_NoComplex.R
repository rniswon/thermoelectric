...
input_data = 'Model_archive/tower/Data/Tower_input_UpTemps_NoComplex.csv'
...
write.csv(evap_out, 'Model_archive/tower/Output/Tower_model_evap_out_UpTemps_NoComplex.csv',row.names=F)
...
write.csv(consumption_out,'Model_archive/tower/Output/Tower_model_consumption_out_UpTemps_NoComplex.csv', row.names=F)
