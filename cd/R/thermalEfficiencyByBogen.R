...
bogen_fuel_heat<-melt(bogen_fuel_heat,id.vars = c("Plant.Code","bogen"),value.name = "FuelHeat")
#netgen by bogen
...
bogen_netgen<-melt(bogen_netgen,id.vars = c("Plant.Code","bogen"),value.name = "NetGen")
...
nuke_fuel_heat<-melt(nuke_fuel_heat,id.vars = c("Plant.Code","bogen"),value.name = "FuelHeat")
...
nuke_netgen<-melt(nuke_netgen,id.vars = c("Plant.Code","bogen"),value.name = "NetGen")
...
bogenData<-dcast(bogenData,Plant.Code+bogen~variable,value.var = "ThermalEfficiency")
