  ...
  test_that("Boiler fuel data variable types are correct",
            {
              ...
              expect_true(if("Reported.Prime.Mover" %in% names(boiler_fuel_data)){
                is.character(boiler_fuel_data$Reported.Prime.Mover)}else{TRUE}, "Error wrong variable type. Reported.Prime.Mover is a character string.")
