...
fewsr(file.path(system.file("extdata", "FEWS_Pond_plants_input.xlsx", package = "FEWSR")), sheet = "FEWS pond only input", type = "pond", output = "xlsx")
# The sheet name is "FEWS pond only input" and the surface water is pond


fewsr(file.path(system.file("extdata", "FEWS_BIG_Lake_plants_input.xlsx", package = "FEWSR")), sheet = 1, type = "lake", output = "csv")
